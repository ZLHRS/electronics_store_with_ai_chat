...
_original_db = os.getenv("DB_NAME", "productdb")
...
from app.presentation.limiters import products_read_limiter, products_write_limiter  # noqa: E402
...
async def app(engine):
    _app = create_app()
    _app.dependency_overrides[products_read_limiter] = lambda: None
    _app.dependency_overrides[products_write_limiter] = lambda: None
    yield _app
