...
_original_db = os.getenv("DB_NAME", "paymentdb")
...
from app.presentation.limiters import payment_limiter  # noqa: E402
...
async def app(engine):
    _app = create_app()
    _app.dependency_overrides[payment_limiter] = lambda: None
    yield _app
