...
_original_db = os.getenv("DB_NAME", "userdb")
...
from app.presentation.limiters import (  # noqa: E402
    favorites_limiter,
    history_limiter,
    profile_read_limiter,
    profile_write_limiter,
)
...
async def app(engine):
    _app = create_app()
    _app.dependency_overrides[profile_read_limiter] = lambda: None
    _app.dependency_overrides[profile_write_limiter] = lambda: None
    _app.dependency_overrides[favorites_limiter] = lambda: None
    _app.dependency_overrides[history_limiter] = lambda: None
    yield _app
