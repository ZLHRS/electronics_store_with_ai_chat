...
_original_db = os.getenv("DB_NAME", "orderdb")
...
from app.presentation.limiters import orders_limiter  # noqa: E402
...
async def app(engine):
    _app = create_app()
    _app.dependency_overrides[orders_limiter] = lambda: None
    yield _app
